...
ADE20k_param = {'crop_size': [473, 473],
                'num_classes': 150, 
                'model': PSPNet50}
cityscapes_param = {'crop_size': [64, 64],
                    'num_classes': 19,
                    'model': PSPNet101}
...
def get_arguments():
    ...
    #parser.add_argument("--img-path", type=str, default='F:/jinhao/PSPNet/input/pedstrain.jpg',
    ...
    #parser.add_argument("--dataset", type=str, default='cityscaapes',
...
def main():
    ...
    h, w = (tf.minimum(crop_size[0], img_shape[0]), tf.minimum(crop_size[1], img_shape[1]))
