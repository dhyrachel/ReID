...
class HGTX(object):
    """
    HGTX
    This dataset is designed to be test only!

    Dataset statistics:
    # identities: 9 (+1 for background)
    # images:180 (query) + 740 (gallery)
    """
    dataset_dir = 'HGTX'
...
class ALERT(object):
    ...
    Reference:
    The Airport Re-Identification datasets used in this research were 
    generated and provided by ALERT (Awareness and Localization of Explosives-
    Related Threats), a Department of Homeland Security Center of Excellence 
    (COE). The views and conclusions contained in this document are those of 
    ...
    URL: http://www.northeastern.edu/alert/transitioning-technology/alert-datasets/alert-airport-re-identification-dataset/
    
    Dataset statistics:
    # identities: 9651
    # images: 24583 (train) + 5660 (query) + 9659 (gallery)
    """
    dataset_dir = 'ALERT'
