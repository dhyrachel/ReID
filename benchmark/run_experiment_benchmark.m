...
params = { 'name','airport',...       % dataset name [viper, airport, DukeMTMC, caviar]
...
params = { 'featureType','IDE_ResNet',... % feature type [whos, gog, gbicov, ldfv, color_texture, hist_lbp, lomo]
...
params = { 'method','NFST',...      % metric learning method [fda, lfda, klfda, mfa, kmfa, xqda, pcca, rpcca, kpcca, NFST, kissme, prdc, svmml]
