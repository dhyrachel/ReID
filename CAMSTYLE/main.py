...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'logs/duke-ide-camstyle-re-rerank'))
    parser.add_argument('--output_feature', type=str, default='pool5')
    #random erasing
    parser.add_argument('--re', type=float, default=0.5)
    # camstyle batchsize
    parser.add_argument('--camstyle', type=int, default=46)
    #  perform re-ranking
    parser.add_argument('--rerank', action='store_true', help="perform re-ranking",default=True)
