...
with tf.Session() as sess:
    ...
    a_list = glob('./Datasets/' + dataset + '/bounding_box_train-HGTX/*.jpg')

    b_save_dir = './test_predictions/' + dataset + '_spgan' + '/bounding_box_train_ALERT2HGTX/'
    a_save_dir = './test_predictions/' + dataset + '_spgan' + '/bounding_box_train_HGTX2ALERT/'
    ...
    for i in range(len(a_list)):
        ...
        img_name = 'ALERT_'+img_name # ALERT_style
    ...
    for i in range(len(b_list)):
        ...
        img_name = 'HGTX_'+img_name #HGTX_style
